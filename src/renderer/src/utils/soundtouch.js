 ...
 * consecutive sequences are const to overlap each other.
 *
...
class Stretch extends AbstractFifoSamplePipe {
  ...
  calculateOverlapLength(overlapInMsec) {
    ...
    var newOvl = (this.sampleRate * overlapInMsec) / 1000;
    if (newOvl < 16) {
      newOvl = 16;
    }
...
export class SoundTouch {
  ...
  getWebAudioNode(context, filter) {
