...
export function sectionNumber(
  ...
  const sectionIdent = sectionMap?.get(section?.attributes?.sequencenum);
  if (sectionIdent) {
    return `${sectionIdent} `;
  }
