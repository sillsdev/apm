  ...
  return (
    <>
      <Button
        ...
        disabled={disabled}
        sx={{ minWidth: isMobileView ? 100 : 200, justifyContent: 'flex-start' }}
      >
      ...
      >
        ...
        <DialogContent>
          <Autocomplete
            value={value}
            onChange={(event, newValue) => isMobileView ? handleChoiceMobile(newValue) : handleSelectAndClose(newValue)}
            onClose={handleLeave}
