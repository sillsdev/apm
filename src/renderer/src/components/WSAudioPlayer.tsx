...
interface IProps {
  ...
  setInitialPosition?: ((position: number | undefined) => void) | undefined;
  allowRecord?: boolean | undefined;
  allowZoom?: boolean | undefined;
  allowSegment?: NamedRegions | undefined;
  allowAutoSegment?: boolean | undefined;
  allowSpeed?: boolean | undefined;
  allowSilence?: boolean | undefined;
  allowDeltaVoice?: boolean | undefined;
  alternatePlayer?: boolean | undefined;
  ...
  defaultRegionParams?: IRegionParams | undefined;
  canSetDefaultParams?: boolean | undefined;
  doReset?: boolean | undefined;
  autoStart?: boolean | undefined;
  setBusy?: ((busy: boolean) => void) | undefined;
  setMimeType?: ((type: string) => void) | undefined;
  setAcceptedMimes?: ((types: MimeInfo[]) => void) | undefined;
  onPlayStatus?: ((playing: boolean) => void) | undefined;
  onProgress?: ((progress: number) => void) | undefined;
  onSegmentChange?: ((segments: string) => void) | undefined;
  onSegmentParamChange?:
    | ((params: IRegionParams, teamDefault: boolean) => void)
    | undefined;
  onStartRegion?: ((position: number) => void) | undefined;
  onBlobReady?: ((blob: Blob | undefined) => void) | undefined;
  setBlobReady?: ((ready: boolean) => void) | undefined;
  setChanged?: ((changed: boolean) => void) | undefined;
  onSaveProgress?: ((progress: number) => void) | undefined; //user initiated
  onDuration?: ((duration: number) => void) | undefined;
  onInteraction?: (() => void) | undefined;
  onRecording?: (r: boolean) => void;
  onCurrentSegment?:
    | ((currentSegment: IRegion | undefined) => void)
    | undefined;
  onMarkerClick?: ((time: number) => void) | undefined;
  reload?: ((blob: Blob) => void) | undefined;
...
function WSAudioPlayer(props: IProps) {
  ...
  const handleRefresh = () => {
    setVoice(
      (getOrgDefault(orgDefaultVoices) as { fullName: string })?.fullName
    );
  };
  useEffect(() => {
    if (org) {
  ...
  const applyAudioAi = (func: AudioAiFunc, targetVoice?: string) => {
    checkOnline((online) => {
      ...
      try {
        ...
        const error = errResult as Error | AxiosError;
  ...
  const handleNormal = async () => {
    ...
    try {
      ...
      if (blob) {
        ...
        const regionblob = new Blob([result as string], { type: blob.type });
