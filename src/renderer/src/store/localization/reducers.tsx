...
const initialState = {
  ...
  access: new LocalizedStrings({
    en: {
      ...
      noOnlineUsers2:
        'Log in and select Offline Available in the audio project card menu and then log out. Or, click IMPORT AUDIO PROJECT to import an audio project your admin exported.',
  ...
  assignSection: new LocalizedStrings({
    en: {
      ...
      modifySections:
        '{0} {1} are selelected but modifying the permissions will change all {2} {3} with this permission scheme',
  ...
  audacityManager: new LocalizedStrings({
    en: {
      ...
      browse: 'Browse',
      checkDownload:
        'Return to the team screen, mark the project for offline use and change modes to let the project be downloaded. That will put the media files into a local folder where Audacity can get them.',
      close: 'Close',
      closeAudacity:
        'Audacity is current running. Close before using this function.',
      create: 'Create',
      exportFirst: 'Open Audacity and use File:Export before importing',
      import: 'Import',
      installError: 'Audacity install error',
      loadingAudio:
        'Use File:Import in Audacity to load current audio if desired.',
      missingImport:
        'Missing import file: {0}. Please open Audacity again and use File, Export to save the contents and then use Import here.',
      missingProject:
  ...
  burrito: new LocalizedStrings({
    en: {
      apmData: 'APM Data',
      audio: 'Audio',
      backTranslation: 'Back Translation',
      books: 'Books',
      cancelCreation: 'Cancel burrito creation',
      create: 'Create Burrito',
      createAudio: 'Create audio burrito',
      createText: 'Create text burrito',
      createNotes: 'Create notes burrito',
      createResources: 'Create resources burrito',
      createIntellectualProperty: 'Create intellectual property burrito',
      createNavigation: 'Create navigation burrito',
      createData: 'Create data burrito',
      createOther: 'Create {0} burrito',
      communityFeedback: 'Community Feedback',
      contents: 'Contents',
      convertToMp3: 'Convert to mp3',
      deselectAll: 'Deselect All',
      discussions: 'Discussions',
      enterNewValue: 'Please enter the new value for',
      failed: 'Failed to create burrito',
      format: 'Format',
      intellectualProperty: 'Intellectual Property',
      navigation: 'Navigation',
      notes: 'Notes',
      open: 'Open',
      preparing: 'Preparing burrito...',
      projects: 'Projects',
      resources: 'Resources',
      selectAll: 'Select All',
      selectedBooks: 'Selected Books',
      success: 'Burrito created successfully!',
      terms: 'Terms',
      text: 'Text',
      textOutputFormat: 'Text output format',
      textOutputUsfm: 'USFM',
      textOutputUsj: 'USJ',
      textOutputUsx: 'USX',
      ...
      vernacularAudioMissingTranscriptionListTitle:
        'Passages missing transcriptions (first {0})',
      vernacularAudioMissingTranscriptionTitle: 'Missing transcription(s)',
      vernacularAudioMissingTranscriptionWarning:
        'Audio files without transcriptions will make it difficult to associate the audio with the proper section.',
      wrapper: 'Wrapper',
    },
  }),
  cards: new LocalizedStrings({
    en: {
      ...
      bibleid: 'Bible Id',
      bibleidexists:
        'Bible Id already exists. Please contact support if you need to work on this Bible.',
      bibleidformat:
        'Bible Id must begin with the language code and version (six letters).',
      ...
      boldProcessInfo:
        'Setting Step Progression and AI Automatic Transcription.',
      cancel: 'Cancel',
      closeNoSave: 'Close without Saving?',
      convertPrompt:
        'Enter the name of the organization that will hold the rights for recordings of the converted voices.',
      ...
      explainPublishing:
        'Information to use when publishing audio created by this team.',
      explainTeamDelete:
        'Deleting the team will delete all audio projects of the team.',
      ...
      recognizePrompt:
        'Choose the language to auto transcribe. If the language is not available, choose a closely related language with a similar writing system.',
  ...
  community: new LocalizedStrings({
    en: {
      addSpeaker: "Add '{0}'",
      autoSegment:
        'Use {0} for autosegmentation, or tap in the waveform and use + for manual segmentation',
      ...
      none: 'none',
      noVoiceCreation:
        'New Voice change samples must be created before a recording is waiting to be saved.',
      playTest: 'Play Test',
      provideRights: 'Provide Rights',
      record: 'Record',
      releaseRights:
        'Upload or record a statement releasing the rights to publish material recorded by this speaker. A suggested script for the recorded permission is given which can be personalized.',
      rights: 'Rights',
  ...
  carefulTranscription: new LocalizedStrings({
    en: {
      ...
      nextClause: 'Next Clause',
      noClauses:
        'No clause segments found. Complete the Careful Speech step first.',
      noRecordingLanguage:
        'Language is not configured for automatic transcription.',
      prerequisite:
        'Complete Careful Speech for every clause before starting Careful transcription.',
  ...
  lwcTranslation: new LocalizedStrings({
    en: {
      ...
      noClauses:
        'No clause segments found. Complete the Careful Speech step first.',
      prerequisite:
        'Complete Careful Speech for every clause before starting LWC translation.',
  ...
  lwcTranscription: new LocalizedStrings({
    en: {
      ...
      noClauses:
        'No clause segments found. Complete the Careful Speech step first.',
      noLwcLanguage:
        'LWC language is not configured on the LWC Translation step.',
      prerequisite:
        'Complete LWC Translation for every clause before starting LWC transcription.',
      progress: '{0} of {1} clauses transcribed',
    },
  }),
  phraseBackTranslationGuided: new LocalizedStrings({
    en: {
      ...
      resetConfirmBoundaries:
        'Resetting will restore segment boundaries to how they were when you opened this step. Continue?',
      resetConfirmRecordings:
        'Resetting will delete back-translation recordings for this language on the current vernacular recording and restore segment boundaries to how they were when you opened this step. Continue?',
      segment: 'Segment: {0}',
      speaker: 'Speaker',
      splitSegment: 'Split',
      startRecording: 'Start Recording',
  ...
  discuss: new LocalizedStrings({
    en: {
      howToChange:
        'Change instructions for this step on the workflow settings for this step.',
    },
  }),
  ...
  electronAuth: new LocalizedStrings({
    en: {
      ...
      tokenExchangeFailed:
        'Could not complete sign-in (token exchange failed).',
      tryAgain: 'Try again',
  ...
  electronImport: new LocalizedStrings({
    en: {
      ...
      importOldFile:
        'This file was not exported from the latest version.  Reexport your PTF file from the online version.',
      ...
      lastExported:
        "Current data in audio project '{name0}' was last exported {date0}.",
      members: 'Members',
      neverExported:
        "Current data in audio project '{name0}' has never been exported to an itf file to preserve changes.",
      newerVersion:
        'This file was exported with a newer version of the program.  You should download the latest version before importing!  If you continue, some data may not be imported correctly.',
      project: 'Audio Project',
      projectImported:
        "Audio Project '{name0}' was previously imported with a newer file: {date1} ",
      ptfError: 'Not a valid Portable Transcriber File',
      userWontSeeProject:
        'You are not a member of this audio project team. This audio project will not be accessible after import.',
    },
  }),
  emailUnverified: new LocalizedStrings({
    en: {
      ...
      verify:
        'Please verify by clicking on the link in the authorization email sent to your account.',
    },
  }),
  ...
  findResource: new LocalizedStrings({
    en: {
      ...
      aiDesc:
        'Copy the query contents and paste it into one or more of the AI chat tools:',
      aquiferSearchTip:
        'The keyword to search on. Currently only searches against content names (not inside content). Non-English names are supported. Must be at least 3 characters in length.',
      resource: '{0} Resource',
      Lang: '{0} Language*',
      ...
      whatsAppHelp:
        "Install the What's App app on your phone and join the group for your language. You can also install What's App on Windows and link to your phone App. Use Meta AI",
  ...
  graphic: new LocalizedStrings({
    en: {
      ...
      keywordSearchHint:
        'The Keywords search only filters the keyword list. To filter images, select one or more keywords or use the main search.',
      loadFailure: 'Failed to load',
      noResults:
        'No matching images found. Try a different search or adjust the filters.',
  ...
  import: new LocalizedStrings({
    en: {
      burritoConvertingBook: 'Converting book {0} of {1}: {2}',
      burritoPreparingLocal: 'Preparing Scripture Burrito locally...',
      burritoReadingFiles: 'Reading files {0} of {1}',
      close: 'Close',
      continue: 'Continue',
      copy: 'Copy Report',
      ...
      error: 'Import Error',
      externalSource:
        'Create a new project in APM from an external source (.ptf)',
      externalSourceBurrito:
        'Create a new project in APM from a Scripture Burrito',
      family: 'Family Name',
      filter: 'Filter',
      fontsize: 'Font Size',
      given: 'Given Name',
      ...
      incrementalImport:
        'Import Incremental Changes from an offline coworker (.itf)',
      invalidITF: 'Not a valid Incremental Transcriber File (ITF).',
      invalidProject: 'Import File does not contain current audio project.',
      locale: 'Preferred Language',
      newTeamChainFailed:
        'Could not determine the new team after the first import. Import the first file alone, then add the rest to that team.',
      noFile: 'Please select file to be uploaded.',
      offlineImport:
        'Import an APM Project File to use offline and sync when online, or a project file from an external source that you will only use offline.  Projects from an external source that are not imported while online cannot be synced online.',
      old: 'Previous Value',
      ...
      projectNotFound:
        'ITF does not contain current audio project.  It contains audio project {0}.',
      selectImportFileType: 'Select import file type:',
      ...
      unknownError:
        'If this error occurred while syncing offline changes, please close the app immediately and reopen.  If the error persists, contact support.  If you continue to use the app, you will lose offline changes.',
      username: 'Name',
    },
  }),
  scriptureBurritoImport: new LocalizedStrings({
    en: {
      ...
      wrapperNotFoundError:
        'wrapper.json not found in the selected file/directory',
    },
  }),
  integration: new LocalizedStrings({
    en: {
      ...
      questionPermission:
        'Do you have permission to edit the {0} project text?',
  ...
  main: new LocalizedStrings({
    en: {
      ...
      crashMessage:
        'Something went wrong. The developers need to address this issue.',
      ...
      inviteError:
        'Invitation not accepted.  You must login with the email that the invitation was sent to.',
      loadingTable: 'Busy...please wait.',
      loadDataOffline:
        'Unable to complete loading while offline. Check your internet connection and try again.',
      ...
      sessionExpireTask:
        'Your session will expire in {0} seconds. Would you like to continue?',
  ...
  mediaTab: new LocalizedStrings({
    en: {
      ...
      pendingUploadDeleteFailed:
        'The online media record could not be removed (id {0}). Others may still see a broken entry until an administrator cleans it up. Your file is saved locally.',
      ...
      pendingUploadQueuedHint:
        'You can retry from Team → {0} when your connection improves.',
      pendingUploadRetryLater:
        'Try again when your internet connection is more stable.',
  ...
  mediaUpload: new LocalizedStrings({
    en: {
      cancel: 'Cancel',
      dragDropMultiple:
        'Drag and drop files here, or click here to browse for the files.',
      dragDropSingle:
        'Drag and drop a file here, or click here to browse for the file.',
      faithbridgeTitle: '{0} Resource',
      githubSupport: 'Github markdown syntax supported',
      graphicTask:
        'Drag and drop a file here, or click here to browse for the file. Formats accepted are .png, .jpg (or .jpeg) and .webp.',
      graphicTitle: 'Upload Graphic',
      intellectualPropertyTask:
        'Upload a speaker rights release for {0} in audio or visual format. Audio formats accepted are .mp3, .m4a, .wav or .ogg. Visual formats accepted are .pdf, .png, or .jpg.',
      intellectualPropertyTitle: 'Upload Speaker Rights Release',
      invalidFile: 'Not valid for this operation: {0} ',
      ITFtask:
        'Upload an Incremental Transcriber File (itf file) exported from the Desktop app.',
      ...
      markdownTask:
        'Enter text to be used as a resource. (Mark down formatting is allowed.)',
      markdownTitle: 'Enter Text',
      preview: 'Preview',
      projectResourceTask:
        'Upload audio files in .mp3, .m4a, .wav or .ogg format or visual content in .pdf format.',
  ...
  newProject: new LocalizedStrings({
    en: {
      ...
      general: 'Quick Start',
      generalFactor1:
        'you have one or a few prerecorded audio files for passages',
      generalFactor2:
        'you just want to try out the program before you set up an actual project',
      generalTip: 'Create a project with one or a few audio files.',
      keyFactors: 'Best option if...',
      likeTemplate:
        'Here are optional ways to get started. Later, you can use the Edit Audio Project Settings dialog box to change any of your initial settings.',
  ...
  passageDetailArtifacts: new LocalizedStrings({
    en: {
      ...
      findResourceDesc:
        'These controls can be used to find or create (using artificial intelligence -- AI) resources for internalizing the passage, section, chapter, or book.',
      ...
      pasteFormat:
        'Pasted data must contain two or three columns. One of them must be the reference.',
      pasteError:
        'Unable to parse {0} segment boundaries. {1} segment boundaries were adjusted.',
      ...
      suffix: 'Suffix',
      suffixTip:
        'A Suffix is added to the end of the Reference (if there is no Description to override it).',
      ...
      tip2b:
        'Steps through connecting chunks of a general resource with {0} and passages.',
      unusedSegment:
        'Unused segment: only segments with References will create resources',
      upload: 'Uploads',
      uploadProject:
        'General - to be used by multiple {0} or passages. (Uploaded files will only appear under Configure General.)',
  ...
  peer: new LocalizedStrings({
    en: {
      ...
      peerDescription:
        'Peer Groups allow you to assign tasks to a group rather than an individual.',
      editPeerGroup: 'Edit Peer Group',
      inSchemeUse:
        'This group is referenced in {0} {2} steps in {1} {2} schemes',
      ...
      remove: 'Remove',
      removeConfirm:
        'Do you want to remove the peer group and information about who are the members?',
    },
  }),
  ...
  permission: new LocalizedStrings({
    en: {
      admin: 'Admin',
      adminTip:
        'Do we need this group?  Or just use team admin? People in this group will be able to do any step, even if it is assigned to a group they are not in.',
      consultant: 'Consultant',
      consultantTip:
        "Not sure we need this permission either, because it is unclear what special things consultants do in this software.  Independent Consultant's comments will be visible to all team members.",
      consultantInTraining: 'Consultant In Training',
      consultantInTrainingTip:
        'CITs comments will only be visible to Mentors until a mentor approves the comment.',
      mentor: 'Mentor',
      mentorTip:
        "Mentor's comments will only be visible to CITs.  Mentors can approve CIT's comments to make them visible to the rest of the team.",
      nspTip:
        'General Peer Group with no special permissions.  Use to assign discussions to team groups.',
    },
  }),
  ...
  planSheet: new LocalizedStrings({
    en: {
      ...
      confirmPublishMovement:
        'If you choose to publish, the {0} and the latest version of all passages and notes in all {0} in this movement will be marked as published. If you have previously published and now choose not to publish, the {0} and passages and notes will be marked as not published.',
      confirmPublishMovementNoPropagate:
        'The publishing status of the {0} in the movement will not be changed. If you choose to publish, the movement will be marked as published. If you have previously published and now choose not to publish, the movement will be marked as not published, but if any {0} are published to {1}, the movement will still appear in {1}.',
      confirmPublishSection:
        'If you choose to publish, the {0} and the latest version of all passages and notes (except linked notes) in this {0} will be marked as published. If you have previously published and now choose not to publish, the passages and notes will be marked as not published.',
      confirmPublishSectionNoPropagate:
        'If you choose to publish, the {0} will be marked as published but the publishing status of the passages and notes in this {0} will not be changed. If you have previously published and now choose not to publish, the {0} will be marked as not published.',
      ...
      goToReferenceScripture: 'Verse reference (chapter and verse ex 2:45)',
      ...
      paratextRequired:
        'You must be a {0} user with access to FOBAI resources and project Editor or Publisher permission to use this feature.',
      ...
      published: 'Publish',
      refErr:
        'This project contains invalid Books or References and will not sync or publish. (A valid reference would be 3:2-5 or similar.)',
      referenceFilteredNoPublishingLabels:
        'Clear the filter to go to a movement/section label (M/S).',
      referenceNotFound: 'No matching row was found.',
  ...
  prompt: new LocalizedStrings({
    en: {
      adminInstructions:
        'Record a short prompt for this section, then save. Team members will listen before they record.',
      offlineCannotAdd:
        'You must be online to add or replace the prompt recording for this section.',
  ...
  projectDownload: new LocalizedStrings({
    en: {
      ...
      download: 'Download?',
      downloadDescription:
        "If the estimated time for download is too long for you, use the 'x' in the upper corner to close this dialog box. Then add a minimum and / or maximum {1} to the filter. The filter icon is {0} (a downward pointing dashed triangle) and is located before the {3} button on the {4} & PASSAGES tab. After setting the {1} filter, choose the filtered option on this dialog box to see how much time will be needed for the filtered {2}.",
      downloadLater: 'Download Later',
      downloadMb:
        'Download {0}MB of offline audio project files? (It may take {1} to download on a fast Internet connection or {2} on a slow broadband connection.)',
      filter: 'Filter',
  ...
  publishLevel: new LocalizedStrings({
    en: {
      ...
      bibleRequired:
        'You must have set up a Bible Id and Name in the Team Settings to publish to {0} or {1}.',
  ...
  recordStepSettings: new LocalizedStrings({
    en: {
      ...
      echoCancellationHelper:
        'Reduces echo when using speakers. May reduce recording quality. Leave off for a cleaner capture when using headphones or a quiet room.',
      fileNameTemplate: 'File Name Template',
      general: 'General',
      noiseSuppression: 'Noise suppression',
      noiseSuppressionHelper:
        'Reduces background noise. May make speech sound less natural. Leave off for the most faithful capture when the environment is already quiet.',
      notes: 'Notes',
  ...
  scriptureTable: new LocalizedStrings({
    en: {
      ...
      publishingWarning:
        'Once publishing rows are added, there is no automated way to remove them. Publishing projects cannot be made flat projects.',
      reference: 'Reference',
      saveFirst: 'You must save changes first!',
      saving: 'Saving...',
      setupGeneralBook:
        'Go the the Home page and sort the projects to set the book codes.',
      setupScriptureBook:
        'Make a selection in the Book column for each passage without one.',
      title: 'Title',
    },
  }),
  ...
  selectArtifactCategory: new LocalizedStrings({
    en: {
      ...
      scriptureHighlight:
        'Resources of this type will be available in steps using the Compare tool.',
    },
  }),
  ...
  shared: new LocalizedStrings({
    en: {
      ...
      ai: 'AI',
      bookNotInParatext:
        'Passage {0}.{1}: {Pt} project does not contain book {2}.',
      ...
      description: 'Description',
      editor: 'Editor',
      expiredParatextToken:
        "Your {Pt} login has expired and can't be automatically renewed.  Please log out and login again.",
      expiredToken:
        "Your login token has expired and can't be automatically renewed.  Please log out and login again.",
      fileNotFound:
        'The audio file has not been downloaded or has been deleted.',
      ...
      observer: 'Observer',
      paratextchapterSpan:
        'Passage {0}.{1} {2}: Passage must not span chapters.',
      part: 'Part {0}',
      passages: 'Passages',
      ...
      referenceNotFound:
        'Reference does not exist in {Pt} chapter, or reference is within a larger verse range.',
      role: 'Role',
      save: 'Save',
      saving: 'Saving...',
  ...
  spelling: new LocalizedStrings({
    en: {
      ...
      restart:
        'To load or unload dictionaries requires this app to be restarted. Loading dictionaries that have not been loaded before will require this device to have a connection to the Internet. Do you want to restart this desktop app now?',
      restartApp: 'Restart',
  ...
  stepEditor: new LocalizedStrings({
    en: {
      ...
      changes: '{0} change(s)',
      duplicatePhraseBtLanguage:
        'Another step already uses this language for the same artifact type.',
      hide: 'Hide',
      inProgress: 'In progress...',
      languageRequired: 'Language is required for this step.',
  ...
  transcriber: new LocalizedStrings({
    en: {
      ...
      aiWillContinue:
        'The AI will continue to work on the transcription even if you close this progress box. Click the {0} button to open the progress box on this workflow step to see the results. Use the settings gear on {0} button to see the transcription using a different language.',
      chooseSisterLang: 'Choose a sister language',
      comment: 'Comment',
      congratulation: 'Congratulations',
      done: 'Completed',
      findingSisterLang: 'Finding supported sister languages…',
      historyTip: 'History [{0}]',
      incomplete: 'Incomplete transcription',
      invalidReference: 'Book or Reference is invalid.',
      missingSegmentRecordings:
        'Some Phrase Back Translation segments are missing recordings. Complete recording for every segment before starting transcription.',
      ...
      scriptTranscription: 'Script',
      invalidSisterLang:
        'This language is not supported for speech recognition. Choose another sister language.',
      sisterLang:
        'Your language is not supported for speech recognition. To use automatic transcription, choose a closely related language with a similar writing system.',
      submit: 'Submit',
  ...
  transcriptionShow: new LocalizedStrings({
    en: {
      ...
      transcriptionDisplay:
        'This display allows you to review the transcription that is stored.',
    },
  }),
  transcriptionTab: new LocalizedStrings({
    en: {
      audioExport: 'Export Audio Files',
      availableOnClipboard:
        'Exported data is available on the clipboard. Use paste to insert it into another program.',
      ...
      writingDownloadFile:
        'Writing file...It could take up to 6 minutes to resume progress.',
      ...
      export: 'Export',
      exportExplanation:
        'Export the full audio project to store locally or share with another offline member. Export incremental file to import changes into online app.',
      ...
      exportTooLarge:
        'The audio project cannot be exported.  The export file is too large.',
      ...
      noData: 'No {0} Data.',
      offlineData:
        'You have new changes locally that were not included in the PTF export.  Please also export an itf file to capture all changes.',
      changed: 'Changed',
      plan: 'Plan',
      scriptureBurrito: 'Scripture Burrito',
      sectionstate: 'State',
  ...
  verse: new LocalizedStrings({
    en: {
      ...
      noReferences:
        'Warning: Some audio segments will not be included in verses',
  ...
  voice: new LocalizedStrings({
    en: {
      ...
      stHired:
        'Since I am being compensated by the team, my voice can be used by the team without additional compensation.',
      stJoin: 'and',
      stLangClause:
        'I understand that {0} will only use my voice with languages I do not regularly use, to prevent impersonation. {1}. ',
  ...
  vProject: new LocalizedStrings({
    en: {
      ...
      errgeneralBookNonScripture:
        'Book Designation must not be a Scripture book code.',
      ...
      isPublic:
        'This project contains resources that can be used in other projects for Internalization.',
      howToPublic:
        'Contact Nathan Payne (nathan_payne at sil.org) for access to create shared content.',
      language: 'Language',
      layout: 'Layout',
      movement: 'Movement',
      movements: 'Movements',
  ...
  welcome: new LocalizedStrings({
    en: {
      alone: 'Work Alone',
      aloneFactor:
        'Audio Projects cannot be changed to team audio projects later',
      import: 'Import Audio Project',
      ...
      setupFactor2Help:
        'Select the Offline Available option on the audio project card menu.',
      setupTeam: 'Set up a team audio project',
      setupTeamTip:
        'Set up the audio project, dividing work into passages that can be assigned to various transcribers and editors.  Transcribers and editors can work online or offline by downloading or importing the audio project.',
      team: 'Work in a team audio project',
      teamFactor: 'Audio Project has been set up online',
      teamTip:
        'A audio project has been set up online.  Transcribers and editors can work online, offline by selecting the Offline Available option on the audio project card menu, or offline by importing it.',
  ...
  workflowSteps: new LocalizedStrings({
    en: {
      ...
      backTranslationTip: 'Record a back translation',
      carefulSpeech: 'Careful speech',
      carefulSpeechTip: 'Record careful speech for each segment.',
      carefulTranscription: 'Careful transcription',
      carefulTranscriptionTip:
        'Transcribe the careful speech recording for each segment.',
      freeTranscription: 'Free transcription',
      freeTranscriptionTip: 'Transcribe the free translation recording.',
      freeTranslation: 'Free translation',
      freeTranslationTip:
        'Record a free translation of the entire passage in the language of wider communication.',
      lwcTranscription: 'LWC transcription',
      lwcTranscriptionTip: 'Transcribe the LWC translation recording.',
      lwcTranslation: 'LWC translation',
      lwcTranslationTip:
        'Listen to each careful speech segment and record a translation in the language of wider communication.',
      communityTest1: 'Community Test 1',
      communityTest1Tip: 'Ask community test questions and record responses',
      communityTest2: 'Community Test 2',
      communityTest2Tip: 'Ask community test questions and record responses',
      communityTesting: 'Community Test',
      communityTestingTip: 'Ask community test questions and record responses',
      consultantCheck: 'Consultant Check',
      consultantCheckTip:
        'The consultant listens to recorded content and asks questions in discussions.',
      ...
      doneTip: 'All steps have been completed for this passage or note',
      export: 'Export',
      exportTip: 'Export work done to this point if desired.',
      finalRecording: 'Studio Record',
      finalRecordingTip: 'Make a final recording in a studio if desired.',
      finalReview: 'Final Audio Review',
      finalReviewTip:
        'Listen one last time to the results to see if any more changes are needed.',
      finalReviewText: 'Final Text Review',
      finalReviewTextTip:
        'Read through the transcription one last time to see if any additional changes are needed.',
      incompleteStepComplete: 'Complete',
      incompleteStepContinue: 'Continue',
      incompleteStepNavigate:
        'The current step ({0}) is not complete. Are you sure?',
      incompleteStepNavigateTitle: 'Step not complete',
      internalize: 'Internalize',
      internalizeTip:
        'Review the resources to become able to tell the passage from memory in the target languages.',
      paratextConsultantCheck: 'Consultant Check in {0}',
      paratextConsultantCheckTip:
        'Review the text in another program with more analysis resources.',
      paratextPeerReview: 'Peer Review in {0}',
      paratextPeerReviewTip:
        'Team reviews the text in another program with more analysis resources.',
      paratextSync: 'Sync to {0}',
      paratextSyncTip: 'Sync text to another text translation tool.',
      peerReview: 'Peer Review',
      peerReviewTip: 'Peer review content to this point.',
      phraseBackTranslation: 'Phrase Back Translate',
      phraseBackTranslationTip:
        'Record a back translation of each phrase of the passage.',
      pBTTranscribe: 'Phrase BT Transcribe',
      pBTTranscribeTip: 'Transcribe each of the back translated phrases.',
      pBTParatextSync: 'Phrase BT {0}',
      pBTParatextSyncTip:
        'Synchronize the back translated text to another tool for analysis and review.',
      preliminaryApproval: 'Preliminary Approval',
      preliminaryApprovalTip: 'Get preliminary approval.',
      record: 'Record',
      recordTip: 'Record the passage.',
      retellBackTranslation: 'Retell Back Translation',
      retellBackTranslationTip:
        'Retell the entire passage in the language understood by the consultant.',
      retellBTTranscribe: 'Retell BT Transcribe',
      retellBTTranscribeTip:
        'Transcribe the recording of the text being retold in the language of the consultant.',
      review: 'Review Transcription',
      reviewTip: 'Review the transcription to make sure it is accurate.',
      saveFirst: 'Save before changing step?',
      teamCheck: 'Compare',
      teamCheckTip:
        'Check over the work of another sub team in the translation project.',
      termVerify: 'Term Verify',
      termVerifyTip:
        'Make recordings of how terms contained in the passage are being rendered.',
      teamReview: 'Term Review',
      teamReviewTip:
        'Review how terms were rendered before and how they are rendered this time.',
      transcribe: 'Transcribe',
      transcribeTip: 'Transcribe the recording.',
      unsaved: 'Unsaved content',
      markVerses: 'Mark Verses',
      markVersesTip:
        'Listen to the recording and mark where the verse boundaries occur.',
      prompt: 'Prompt',
      promptAdminTip:
        'Record a prompt for this section, save it, then continue to the next step when ready.',
      promptTip: 'Listen to the prompt above. Then, move to the next step.',
      wholeBackTranslate: 'Whole Back Translate',
      wholeBackTranslateTip:
        'Record the back translation of the entire passage in the language of the consultant.',
      wholeBackTranslation: 'Whole Back Translate',
      wholeBackTranslationTip:
        'Record the back translation of the entire passage in the language of the consultant.',
      wBTTranscribe: 'Whole BT Transcribe',
      wBTTranscribeTip:
        'Transcribe the recording of the passage in the language of the consultant.',
      wBTParatextSync: 'Whole BT {0}',
      wBTParatextSyncTip:
        'Sync transcription of the back translation to another tool for analysis and review.',
      none: '(None)',
    },
  }),
  wsAudioPlayer: new LocalizedStrings({
    en: {
      ...
      aiInProgress:
        'AI Service In Progress...  This is a remote service that may take a long time if the recording is large, or if there are other requests ahead of yours.',
      beginVoiceConvert: 'Beginning voice conversion...',
      backTip: 'Rewind {jump} {1} [{0}]',
      convertVoice: 'Convert Voice {0}',
      clearRecording: 'Clear Recording?',
      clearRecordingTip: 'Clear Recording',
      convertVoiceAi: 'Convert Voice (AI)',
      ...
      seconds: 'seconds',
      selectMicrophoneMenu: 'Select Microphone',
      selectVoice: 'Select Voice',
      selectVoiceForConversion: 'Select Voice for Conversion',
      selectVoicePrompt:
        'Enter the full name of the person whose voice will be used to modify the voice or voices in the original recording.',
      silence: 'Silence',
      slowerTip: 'Slower [{0}]',
      stopTip: 'Stop [{0}]',
      ...
      voiceconversionFailed:
        'Voice convert failed (More than likely, the server is unavailable).',
    },
  }),
  ...
  switch (action.type) {
    case FETCH_LOCALIZATION:
      return {
        ...
        burrito: new LocalizedStrings(action.payload.data.burrito),
        ...
        carefulTranscription: new LocalizedStrings(
          action.payload.data.carefulTranscription
        ),
        lwcTranslation: new LocalizedStrings(
          action.payload.data.lwcTranslation
        ),
        lwcTranscription: new LocalizedStrings(
          action.payload.data.lwcTranscription
        ),
        phraseBackTranslationGuided: new LocalizedStrings(
          action.payload.data.phraseBackTranslationGuided
        ),
        consultantCheck: new LocalizedStrings(
        ...
        scriptureBurritoImport: new LocalizedStrings(
          action.payload.data.scriptureBurritoImport
        ),
