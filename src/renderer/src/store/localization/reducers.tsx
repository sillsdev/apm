...
const initialState = {
	...
	"phraseBackTranslationGuided": new LocalizedStrings({
		"en": {
			...
			"noStepLanguage": "Configure a language for this Phrase Back Translation step in Step Editor before recording.",
	...
	"findResource": new LocalizedStrings({
		"en": {
			...
			"sortGroupingName": "Source",
			"sortGroupingType": "Group",
			"sortMediaType": "Media",
			"sortMenu": "Sort results",
			"sortName": "Name",
			"summary": "summary",
	...
	"graphic": new LocalizedStrings({
		"en": {
			...
			"noResults": "No matching images found. Try a different search or adjust the filters.",
	...
	"import": new LocalizedStrings({
		"en": {
			...
			"incrementalImport": "Import Incremental Changes from an offline coworker (.itf)",
			"invalidITF": "Not a valid Incremental Transcriber File (ITF).",
			"invalidProject": "Import File does not contain current audio project.",
			"locale": "Preferred Language",
			"newTeamChainFailed": "Could not determine the new team after the first import. Import the first file alone, then add the rest to that team.",
			"noFile": "Please select file to be uploaded.",
			"offlineImport": "Import an APM Project File to use offline and sync when online, or a project file from an external source that you will only use offline.  Projects from an external source that are not imported while online cannot be synced online.",
			"old": "Previous Value",
	...
	"scriptureBurritoImport": new LocalizedStrings({
		"en": {
			...
			"selected": "Selected: ",
			"wrapperNotFoundError": "wrapper.json not found in the selected file/directory",
		}
	}),
	...
	"main": new LocalizedStrings({
		"en": {
			...
			"updateFailedNetwork": "Could not reach the server to save your last change. It was undone - please check your connection and try again.",
			"upload": "Upload",
			"version": "Version: {0} - {1}",
	...
	"mediaUpload": new LocalizedStrings({
		"en": {
			...
			"pdfResourceTitle": "Upload PDF Resource",
			"preview": "Preview",
			"projectResourceTask": "Upload audio files in .mp3, .m4a, .wav or .ogg format.",
			"PTFtask": "Upload a Portable Transcriber File (PTF).",
			"PTFtitle": "Upload complete Audio Project Data from PTF",
			"resourceTask": "Upload audio files in .mp3, .m4a, .wav or .ogg format.",
	...
	"passageDetailArtifacts": new LocalizedStrings({
		"en": {
			...
			"deleteGeneralResource": "Do you want to delete the entire general resource or just this one?",
			...
			"uploadProject": "Multiple {0} or Passages (General Resource)",
			"uploadTab": "Upload",
	...
	"planSheet": new LocalizedStrings({
		"en": {
			...
			"referenceFilteredNoPublishingLabels": "Clear the filter to go to a movement/section label (M/S).",
	...
	"profile": new LocalizedStrings({
		"en": {
			...
			"deleteFailed": "Could not delete your account. Try again.",
	...
	"shared": new LocalizedStrings({
		"en": {
			...
			"loadError": "The passage has not properly loaded. You can verify that the passage has audio or continue waiting.",
			"loading": "Loading...",
			...
			"NoSaveStayOnPage": "If you leave this page before saving, your changes will be lost.",
	...
	"stepEditor": new LocalizedStrings({
		"en": {
			...
			"changes": "{0} change(s)",
			"duplicatePhraseBtLanguage": "Another step already uses this language for the same artifact type.",
			"hide": "Hide",
	...
	"transcriber": new LocalizedStrings({
		"en": {
			...
			"sisterLang": "Your language is not supported for speech recognition. To use automatic transcription, choose a closely related language with a similar writing system.",
			"submit": "Submit",
	...
	"voice": new LocalizedStrings({
		"en": {
			...
			"aiipStatement": "I {0} provide consent for {1} to record and store this file with my voice in the cloud and possibly in a voice library for publishing and use in AI applications that require a voice sample, including voice conversion. The recording created by {1} of me reading this script will become the exclusive property of {1} which shall have the unlimited right to make, have made, use, copy, display in public, reconstruct, repair, modify, reproduce, publish, distribute and sell the Work Product, in whole or in part, or combine the Work Product with other matter, or not use the Work Product at all, as it sees fit. {1} will use the recording in a variety of ways, including, but not limited to, Audio books, narrating apps, and scripture engagement to further the mission of the organization. {2}{3} I have been provided this script in a language I understand, and have been given the option to request this script in a language of my choice. This recording will act as my signature in place of a written agreement. {4} I sign with my voice, {5}.",
			"ipStatement": "I {0} give {1} permission to record and use my recordings and other contributions made for {2}. I grant {1} a perpetual, worldwide, royalty-free right to record, reproduce, edit, modify, combine, publish, distribute, broadcast, stream, and otherwise use Work Products I make, in whole or in part, in the {2} and in any derivative works, whether now existing or developed in the future. My Work Products are the exclusive property of {1}, which shall have the unlimited right to make, have made, use, copy, repair, modify, reproduce, publish, distribute and sell the Work Products, in whole or in part, or combine the Work Products with other matter, or not use the Work Products at all, as it sees fit. {1} will use the Work Products in a variety of ways, including, but not limited to, Scripture Publication, Audio books, narrating apps, and scripture engagement to further the mission of the organization. I have been provided this script in a language I understand, and have been given the option to request this script in a language of my choice. This recording will act as my signature in place of a written agreement. {4} I sign with my voice, {5}.",
			"stTeam": "the {0} team",
	...
	"workflowSteps": new LocalizedStrings({
		"en": {
			...
			"carefulTranscriptionTip": "Transcribe the careful speech recording for each segment.",
			...
			"freeTranslationTip": "Record a free translation of the entire passage in the language of wider communication.",
			...
			"lwcTranslationTip": "Listen to each careful speech segment and record a translation in the language of wider communication.",
			...
			"consultantCheck": "Consultant Check",
			"consultantCheckTip": "The consultant listens to recorded content and asks questions in discussions.",
			"consultantCheck1": "First Consultant Check",
			"consultantCheck1Tip": "The consultant listens to recorded content and asks questions in discussions.",
			"consultantCheck2": "Second Consultant Check",
			"consultantCheck2Tip": "The consultant listens to recorded content and asks questions in discussions.",
			"done": "Done",
			...
			"finalReviewTip": "Listen one last time to the results to see if any more changes are needed.",
			"finalReviewText": "Final Text Review",
			"finalReviewTextTip": "Read through the transcription one last time to see if any additional changes are needed.",
			"incompleteStepComplete": "Complete",
			"incompleteStepContinue": "Continue",
			"incompleteStepNavigate": "The current step ({0}) is not complete. Are you sure?",
			"incompleteStepNavigateTitle": "Step not complete",
			"internalize": "Internalize",
			"internalizeTip": "Review the resources to become able to tell the passage from memory in the target languages.",
			"paratextConsultantCheck": "Consultant Check in {0}",
			"paratextConsultantCheckTip": "Review the text in another program with more analysis resources.",
			"paratextPeerReview": "Peer Review in {0}",
			"paratextPeerReviewTip": "Team reviews the text in another program with more analysis resources.",
			...
			"phraseBackTranslationTip": "Record a back translation of each phrase of the passage.",
			...
			"pBTParatextSyncTip": "Synchronize the back translated text to another tool for analysis and review.",
			...
			"retellBackTranslationTip": "Retell the entire passage in the language understood by the consultant.",
			"retellBTTranscribe": "Retell BT Transcribe",
			"retellBTTranscribeTip": "Transcribe the recording of the text being retold in the language of the consultant.",
			...
			"teamCheck": "Compare",
			"teamCheckTip": "Check over the work of another sub team in the translation project.",
			"termVerify": "Term Verify",
			"termVerifyTip": "Make recordings of how terms contained in the passage are being rendered.",
			"teamReview": "Term Review",
			"teamReviewTip": "Review how terms were rendered before and how they are rendered this time.",
			"transcribe": "Transcribe",
			...
			"wholeBackTranslationTip": "Record the back translation of the entire passage in the language of the consultant.",
			"wBTTranscribe": "Whole BT Transcribe",
			"wBTTranscribeTip": "Transcribe the recording of the passage in the language of the consultant.",
			"wBTParatextSync": "Whole BT {0}",
			"wBTParatextSyncTip": "Sync transcription of the back translation to another tool for analysis and review.",
			"none": "(None)",
		}
	}),
