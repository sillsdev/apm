...
<<<<<<< HEAD
  ...
  import: new LocalizedStrings({
    en: {
      ...
      unknownError:
        'If this error occurred while importing offline changes, please close the app immediately and reopen.  If the error persists, contact support.  If you continue to use the app, you will lose offline changes.',
      invalidProject: 'Import File does not contain current audio project.',
...
=======
	...
	"planSheet": new LocalizedStrings({
		"en": {
			...
			"publish": "Publish {0} {1}",
			"published": "Publish",
			"refErr": "This project contains invalid Books or References and will not sync or publish. (A valid reference would be 3:2-5 or similar.)",
			"removeFilter": "Filter must be cleared to enable publishing.",
			"resequence": "Re-sequence",
			"save": "Save",
			"saving": "Saving...",
	...
	"scriptureTable": new LocalizedStrings({
		"en": {
			...
			"saveFirst": "You must save changes first!",
			"saving": "Saving...",
			"setupGeneralBook": "Go the the Home page and sort the projects to set the book codes.",
			"setupScriptureBook": "Make a selection in the Book column for each passage without one.",
			"title": "Title",
		}
	}),
	"scriptureTableFilter": new LocalizedStrings({
