...
function integrateWasmJS(Module) {
  ...
  var wasmTextFile = Module['wasmTextFile'] || 'opusenc.wast';
  var wasmBinaryFile = Module['wasmBinaryFile'] || 'opusenc.wasm';
  var asmjsCodeFile = Module['asmjsCodeFile'] || 'opusenc.temp.asm.js';
...
Module['asm'] = asm;
var _encode_buffer = (Module['_encode_buffer'] = function () {
  return Module['asm']['_encode_buffer'].apply(null, arguments);
});
