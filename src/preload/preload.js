...
contextBridge.exposeInMainWorld('electron', {
  ...
  login: async (hasUsed, email) => await ipcRenderer.invoke('login', hasUsed, email),
  ...
  setSpellLangs: async (codes) => await ipcRenderer.invoke('setSpellLangs', codes),
  ...
  isProcessRunning: async (name) => await ipcRenderer.invoke('isProcessRunning', name),
  createFolder: async (folder) => await ipcRenderer.invoke('createFolder', folder),
  exists: async (name) => await ipcRenderer.invoke('exists', name),
  stat: async (folderPath) => await ipcRenderer.invoke('stat', folderPath),
  read: async (filePath, options) => await ipcRenderer.invoke('read', filePath, options),
  write: async (filePath, data, options) =>
    await ipcRenderer.invoke('write', filePath, data, options),
  append: async (filePath, data) => await ipcRenderer.invoke('append', filePath, data),
  ...
  exec: async (cmd, args, opts) => await ipcRenderer.invoke('exec', cmd, args, opts),
  ...
  zipReadText: async (zip, name) => await ipcRenderer.invoke('zipReadText', zip, name),
  ...
  zipWrite: async (zip, where) => await ipcRenderer.invoke('zipWrite', zip, where),
  ...
  zipStreamExtract: async (zip, folder) =>
    await ipcRenderer.invoke('zipStreamExtract', zip, folder),
  zipStreamOpen: async (zip, fullPath) => await ipcRenderer.invoke('zipStreamOpen', zip, fullPath),
  zipStreamEntries: async (zip) => await ipcRenderer.invoke('zipStreamEntries', zip),
  zipStreamEntry: async (zip, name) => await ipcRenderer.invoke('zipStreamEntry', zip, name),
  zipStreamEntryData: async (zip, name) =>
    await ipcRenderer.invoke('zipStreamEntryData', zip, name),
  zipStreamEntryText: async (zip, name) =>
    await ipcRenderer.invoke('zipStreamEntryText', zip, name),
  zipStreamClose: async (zip) => await ipcRenderer.invoke('zipStreamClose', zip),
  writeBuffer: async (filePath, blob) => await ipcRenderer.invoke('writeBuffer', filePath, blob),
  downloadFile: async (url, localFile) => await ipcRenderer.invoke('downloadFile', url, localFile),
  ...
  downloadClose: async (token) => await ipcRenderer.invoke('downloadClose', token),
  normalize: async (input, output) => await ipcRenderer.invoke('normalize', input, output)
})
